...
class _UpdateUserFormState extends State<UpdateUser> {
  ...
  _updateUserData(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      ...
      final db = SqlLiteDb();
      db.updateUser(userUpdated).then((value) {
        AwesomeDialog(
          context: context,
  ...
  _deleteUserData(BuildContext context) {
    AwesomeDialog(
      ...
      btnOkOnPress: () {
        final db = SqlLiteDb();
        db.deleteUser(_userLoginController.text.trim()).then((value) {
          AwesomeDialog(
            context: context,
            headerAnimationLoop: false,
            dialogType: DialogType.success,
  ...
  _openChatScreen(UserModel recipient) {
    Navigator.push(
      context,
      MaterialPageRoute(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () => _openChatScreen(user),
                          style: ElevatedButton.styleFrom(
                              shape: const StadiumBorder()),
                          child: const Text(
                            'Chat',
